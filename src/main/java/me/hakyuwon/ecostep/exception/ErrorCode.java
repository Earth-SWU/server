...
public enum ErrorCode {
    ...
    INSUFFICIENT_WATER(HttpStatus.BAD_REQUEST, "물이 부족합니다."),
    INSUFFICIENT_FERTILIZER(HttpStatus.BAD_REQUEST, "비료가 부족합니다."),
    ...
    USER_BADGE_ALREADY_EXISTS(HttpStatus.CONFLICT, "이미 해당 뱃지를 보유하고 있습니다."),
